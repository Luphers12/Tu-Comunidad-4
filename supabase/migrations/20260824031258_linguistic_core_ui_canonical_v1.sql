...
('Español','Español','es'),('English','English','en'),('Achi','Achi',NULL),('Akateko','Akateko',NULL),('Awakateko','Awakateko',NULL),('Chalchiteko','Chalchiteko',NULL),('Ch''orti''','Ch''orti''',NULL),('Chuj','Chuj','cac'),('Itza''','Itza''',NULL),('Ixil','Ixil',NULL),('Jakalteko/Popti''','Jakalteko/Popti''',NULL),('Kaqchikel','Kaqchikel',NULL),('K''iche''','K''iche''',NULL),('Mam','Mam',NULL),('Mopan','Mopan',NULL),('Poqomam','Poqomam',NULL),('Poqomchi''','Poqomchi''',NULL),('Q''anjob''al','Q''anjob''al',NULL),('Q''eqchi''','Q''eqchi''',NULL),('Sakapulteko','Sakapulteko',NULL),('Sipakapense','Sipakapense',NULL),('Tektiteko','Tektiteko',NULL),('Tz''utujil','Tz''utujil',NULL),('Uspanteko','Uspanteko',NULL);
