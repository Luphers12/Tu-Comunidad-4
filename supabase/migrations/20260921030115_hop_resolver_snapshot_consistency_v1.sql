...
comment on function public.tc_resolve_logistics_demand(uuid,text,integer) is
'Creates one internally consistent availability snapshot per routing attempt. CURRENT_EXECUTABLE is observational; commit rechecks capacity atomically.';
