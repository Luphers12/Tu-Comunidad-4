...
import 'feature_tag_model.dart';
export 'feature_tag_model.dart';
...
class _FeatureTagWidgetState extends State<FeatureTagWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FeatureTagModel());
  }
